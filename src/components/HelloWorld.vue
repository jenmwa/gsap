<script lang="ts">
    ...
    gsap.from('#globe', {delay: 4, scale: 0,  duration: 10, transformOrigin: 'center center', onComplete: this.heart});

    gsap.from('#W, #R, #L, #D', {delay: 12, opacity:0, duration: 1, });

    gsap.from('#grupp_world', {delay: 12, fill: 'black', duration: 3.5,});
    gsap.to('#grupp_world', {delay: 13, fill: '#cddc39', duration: 7 },);
    gsap.from('#grupp_world', {delay: 17, fill: '#cddc39', duration: 3.5 },);

    gsap.fromTo('#L', {delay: 21, fill: 'black', duration: 5 }, {delay: 17, fill: '#2196f3', duration: 3.5 },);
